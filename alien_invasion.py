...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        # Get rid of bullets after they have dissapeared from the screen.
        for bull in self.bullet.copy():
            if bull.rect.bottom <= 0:
                self.bullet.remove(bull)
    ...
    def _update_screen(self):
        ...
        # Make the most recently drawn screen be displayed
        pygame.display.flip()
